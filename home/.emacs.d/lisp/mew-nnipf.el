...

(defvar mew-absfilter-program "/home/kotaro/bin/nnipfmh --file")
(defvar mew-absfilter-arg-check '("--quiet" ))
(defvar mew-absfilter-arg-clean '("--good" "--update"))
(defvar mew-absfilter-arg-spam '("--bad" "--update"))
