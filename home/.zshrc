...
alias google-chrome='google-chrome --user-data-dir=$HOME/.config/google-chrome-beta --proxy-server=http://127.0.0.1:8123'
...
export EDITOR='vim'
export PATH=$PATH:/usr/local/redpen/bin:$HOME/bin
export LESS=-R
export RM=-i
export MV=-i
export CP=-i
